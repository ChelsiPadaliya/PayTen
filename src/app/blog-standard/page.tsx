...
import BlogStandardInner from "@/components/BlogStandardInner";

export const generateMetadata = async (): Promise<Metadata> => {
  return {
    title: "Blog Standard | PayOne Money Exchange Next JS Template",
    description:
    ...
    openGraph: {
      title: "Blog Standard | PayOne",
      description:
        "PayOne is a professional Next JS Template for online money exchange, remittance, and digital payment services. Clean design, responsive layout, and modern UI components included.",
      url: "https://nextjs.payone.wowtheme7.com/blog-standard",
      type: "website",
      images: [
        {
