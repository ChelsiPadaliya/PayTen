            ...
            <div className='col-lg-5'>
              <div className='max-w-416'>
                ...
                >
                  ...
                  <h5 className='fw-normal text-dark-600 tw-mb-2 cursor-big' style={{ color: "#ED1B23" }}> 
            ...
            <div className='col-lg-7'>
              <div className='position-relative'>
                ...
                <div
                  ...
                  data-aos-duration={1000}
                >
                  <div className='our-feature-card-three max-w-219 rounded-3 tw-px-6 tw-py-5 d-flex align-items-center tw-gap-4 position-absolute inset-inline-start-0 inset-block-start-0' style={{ backgroundColor: '#FBB713' }}>
                    <Image
                      width={54}
                      height={54}
                    ...
                    />
                    <div>
                      <h3 className='fw-normal text-dark-600 mb-0 cursor-big counter' style={{ color: "#fff" }}>
                        {/* CounterView */}
                        <CounterView start={0} end={45} title='K+' />
                      </h3>
                      <span className='fw-normal tw-text-lg text-dark-500' style={{ color: "#fff" }}>
                        Success rate
                      </span>
                    </div>
                  </div>
                ...
                <div
                  ...
                  data-aos-duration={1000}
                >
                  <div className='our-feature-card-four max-w-176 rounded-3 tw-px-6 tw-py-5 position-absolute inset-block-end-0 inset-inline-end-0' style={{ backgroundColor: '#FBB713' }}>
                    <div>
