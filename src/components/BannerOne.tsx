        ...
        <div className="container">
          <div className="position-relative">
                ...
                <div className="max-w-571-px">
                  ...
                  >
                    <div className="max-w-248-px position-relative w-100">
                      <a
                        href="#"
                        className="articles-view-link fw-semibold w-100 tw-py-3 text-center tw-text-lg rounded-3 tw-duration-500"
                        style={{
            ...
            <div className="banner-shape-five bg-white tw-py-5 tw-px-6 rounded-3 max-w-261 position-absolute inset-block-start-50px inset-inline-end--120px d-lg-block d-none z-1 animation-Updowm__two">
              <span className="tw-text-lg fw-semibold tw-mb-3"  style={{ color: "#ED1B23" }}>
                Payment Received
              </span>
              <h4 className="fw-normal tw-mb-3 counter"  style={{ color: "#ED1B23" }}>
                {/* CounterView */}
                +<CounterView start={0} end={358900} title="" />
              </h4>
              <div className="d-flex align-items-center tw-gap-2 justify-content-between">
                <span
                  className="tw-text-lg fw-semibold"
                  style={{ color: "#ED1B23" }}
                >
                  1st Jan, 2025
                </span>
          ...
          <div
            className="banner-brand-item  tw-pt-15 tw-ps-15 tw-pb-8 tw-pe-7  tw-w-1662-px tw-w-100vw banner-slider-bg-clip-path banner-clip__path-rtl border-top-left-80-px margin-top--94px"
            style={{ backgroundColor: "#ED1B23" }}
          >
            <h3
              className=" fw-normal cursor-big tw-mb-2 text-white"
              data-aos="fade-up"
              data-aos-duration={800}
            >
              Join&nbsp;
            ...
            <h5
              className="fw-normal tw-mb-8 text-white"
              data-aos="fade-up"
              data-aos-duration={1000}
            >
