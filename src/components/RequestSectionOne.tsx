      ...
      >
        <div className='container'>
          <div className='max-w-1076 bg-white justify-content-center align-items-center mx-auto'>
            <ul
              className='nav nav-pills text-center d-flex align-items-center justify-content-center tw-mb-8'
              id='pills-tab'
              role='tablist'
              ...
              >
                <div className='tw-px-8 tw-pb-8 z-2'>
                  <div className='tw-mb-6 text-center'>
                    <h4 className='fw-normal tw-mb-2 cursor-big' style={{ color: "#ED1B23" }}>Send Money</h4>
