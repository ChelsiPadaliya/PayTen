          ...
          <div className='col-xl-3 col-lg-4 col-md-6'>
            ...
            >
              <div className='tw-px-8 tw-py-8 bg-white tw-rounded-xl tw-duration-500 position-relative group-hover-bg-base-two-600'>
                <span className='tw-w-15 tw-h-15 tw-rounded-md bg-base-two-10 d-flex align-items-center justify-content-center tw-duration-500 tw-mb-10' style={{ backgroundColor: '#FBB713' }}>
                  <Image
                    width={34}
                    height={34}
                ...
                <button
                  type='button'
                  className='tw-w-16 tw-h-16 bg-white position-absolute top-0 tw-end-0 rounded-circle tw-text-6 text-dark-600 d-flex align-items-center justify-content-center z-1 tw-duration-500'
