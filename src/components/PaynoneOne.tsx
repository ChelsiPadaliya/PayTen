      ...
      <div className='container'>
        <div className='paynone-item margin-block-start-60px'>
          <div className='text-center justify-content-center align-items-center'>
            ...
            >
              PayTen is constantly growing for a World without high fees.
            </p>
          </div>
        </div>
          ...
          <div className='col-xl-4 col-lg-4 col-md-6'>
            ...
            >
              <div className='max-w-212 text-center justify-content-center align-items-center mx-auto'>
                <h4 className='fw-normal text-dark-600 tw-mb-6 cursor-big' style={{ color: "#fff" }}>
                  One Contract, One Integration
                </h4>
                <p className='fw-normal tw-text-xl text-dark-600' style={{ color: "#fff" }}>
