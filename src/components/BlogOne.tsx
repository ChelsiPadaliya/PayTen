        ...
        <div className="d-flex tw-gap-5 justify-content-between flex-wrap tw-mb-80-px">
          <div className="max-w-768">
            ...
            >
              <Image
                ...
                className=""
              />
              <h5 className="text-primary-600 fw-normal">Articles</h5>
            </div>
            <h2
          ...
          <div className="max-w-350">
            ...
            >
              <Link
                href="#"
                className="articles-link w-100 text-center tw-py-205 rounded-3 tw-text-lg border-two-px-solid fw-semibold hover-text-dark-600"
                style={{
          ...
          <div className="col-xxl-6">
            ...
            >
              ...
              <div className="tw-px-4 tw-pb-2">
                ...
                <h3 className="fw-normal tw-mb-3 text-dark-600 cursor-big" style={{ color: "#ED1B23" }}>
                ...
                <div className="position-relative z-1 max-w-160-px w-100">
                  <Link
                    href="#"
                    className="articles-view-link w-100 text-center tw-py-205 rounded-3 fw-semibold tw-text-lg hover-text-dark-600"
                    style={{
                      backgroundColor: "#FBB713",
                      color: "#fff",
                      border: "2px solid #ED1B23",
            ...
            <div className="">
              ...
              >
                ...
                <div className="articles-text max-w-320 tw-px-3 tw-py-5">
                  ...
                  <h4 className="fw-normal tw-mb-3 text-dark-600 cursor-big line-clamp-2" style={{ color: "#ED1B23" }}>
