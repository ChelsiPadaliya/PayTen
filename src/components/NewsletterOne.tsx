            ...
            <div className='max-w-430 w-100'>
              ...
              <div className='d-flex align-items-center tw-gap-6 flex-wrap'>
                <div className='d-flex align-items-center'>
                  ...
                  />
                  <span className='w-15 h-15 rounded-circle text-dark-600 d-flex align-items-center justify-content-center border-white margin-inline-start--20px flex-shrink-0' style={{ backgroundColor: '#FBB713' }}>
                    +15K
                  </span>
                </div>
                <div>
